...
export default function PortfolioHero({ onScrollDown }: PortfolioHeroProps) {
    ...
    >
      ...
      <main className="relative min-h-screen flex flex-col">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full px-4">
          <div className="relative text-center flex flex-col items-center gap-0">
            <div
              className="text-center text-[60px] sm:text-[80px] md:text-[100px] lg:text-[120px] font-bold tracking-tighter lowercase leading-[0.75]"
