...
export function MagneticText({ text = "CREATIVE", hoverText = "EXPLORE", className, textClassName = "text-5xl", style }: MagneticTextProps) {
  ...
  return (
    ...
    >
      ...
      <span className={cn("font-bold tracking-tighter tracking-wide", textClassName)} style={{ color: style?.color || "inherit" }}>{text}</span>
      ...
      >
        ...
        >
          <span className={cn("font-bold tracking-tighter whitespace-nowrap tracking-wide", textClassName)} style={{ color: "#000000" }}>
            {hoverText}
          </span>
        </div>
      </div>
