...
function TestimonialCard({
  ...
  return (
    <a
      ...
      className={cn(
        "relative flex h-auto min-h-[180px] sm:min-h-[220px] w-[320px] sm:w-[450px] -skew-y-[8deg] select-none flex-col rounded-2xl border border-border bg-card/90 backdrop-blur-sm px-4 sm:px-5 py-4 sm:py-5 transition-all duration-500 hover:border-border/80 hover:bg-card cursor-pointer",
  ...
  const defaultCards: TestimonialCardProps[] = [
    {
      ...
      username: "Sam Altman",
      handle: "@samaltman",
      content: "bros the goat at coding",
      date: "Jan 3, 2025",
      verified: true,
      likes: 10000,
      retweets: 2000,
    ...
    },
    {
      ...
      handle: "@sundarpichai",
      content: "google needs chetan highkey",
      date: "Jun 5, 2024",
      verified: true,
      likes: 50000,
      retweets: 6000,
    ...
    },
    {
      ...
      username: "Elon Musk",
      handle: "@elonmusk",
      content: "I offered him Mars, he said 'shipping to production is harder.' Respect.",
      date: "Jan 1, 2023",
      verified: true,
      likes: 100000,
      retweets: 10000,
